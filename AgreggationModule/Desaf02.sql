...
-- 9.Let’s order delivery to the house!Find all the close by spots in Midtown, Downtown or Chinatown.()OR can be used more than once)
...
SELECT *
FROM nomnom
ORDER BY review > 4 DESC LIMIT 10;
